...
VanetRoutingExperiment::Run ()
{
  ...
  CheckThroughput ();
AnimationInterface anim("vanet.xml"); //to run NetAnim
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
  ...
  else if (m_scenario == 2)
    {
      ...
      m_traceFile = "/home/rakha/mobili.tcl";
      m_logFile = "justlog.log";
      m_mobility = 1;
      m_nNodes = 75;
      m_TotalSimTime = 300.01;
      m_nodeSpeed = 20;
      m_nodePause = 0;
      m_CSVfileName = "mobcsv.csv";
      m_CSVfileName = "mobcsv2.csv";
    }
}
